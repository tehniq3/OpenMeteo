...
// Functie noua pentru Indicele European de Calitate a Aerului (EAQI)
...
void loop() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // ==========================================
    // PARTEA 1: DATE METEO (Vreme, Presiune, UV)
    // ==========================================
    {
      ...
      String url = "https://api.open-meteo.com/v1/forecast?latitude=" + String(latitude, 4) + 
                   ...
                   "&current=temperature_2m,relative_humidity_2m,surface_pressure,pressure_msl,weather_code,wind_speed_10m,wind_direction_10m,uv_index&timezone=auto";
    ...
    // ==========================================
    {
      ...
      // Linkul separat pentru calitatea aerului de la Open-Meteo
      ...
      if (httpCode2 > 0) {
        ...
        DynamicJsonDocument doc2(512); // Json mai mic pentru aer
